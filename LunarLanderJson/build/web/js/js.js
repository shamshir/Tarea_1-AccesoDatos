...
window.onload = function () {
    ...
    // Petición de Lectura del Archivo Json (JQuery)
...
function cambiarNave() {
    var newColorNave = prompt("Indica el color de nave deseado:", "blanco o amarillo");
    if (newColorNave !== null) {
        if (newColorNave === "blanco" || newColorNave === "amarillo") {
            colorNave = newColorNave;
            prepararNave();
            guardarConfig();
        }
    }
...
function guardarConfig() {
    ...
    $.ajax({
        method: "POST",
        url: url,
        data: {"modoDificil": modoDificil, "colorNave": colorNave},
        success: function (u) {
            alert(u["mess"]);
        },
        error: function (e) {
