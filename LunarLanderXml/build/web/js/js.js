...
function leerXml() {
    ...
    $(xmlObject).find("configuracion").each(function (i) {
        var nombre = $(this).attr("nombre");
        var mDif = $(this).find("modoDificil").text();
        var cNave = $(this).find("colorNave").text();
...
function guardarConfiguracion() {
    ...
    escribirXml(nombreConfig);
}

function escribirXml(nombreConfig) {
    var url = "defaultServlet";
